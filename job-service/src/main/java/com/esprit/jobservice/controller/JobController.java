...
public class JobController {
    ...
    @GetMapping
    public ResponseEntity<List<JobResponseDTO>> getAll() { return ResponseEntity.ok(jobService.getAllJobs()); }
    @GetMapping("/{id}")
    ...
    public ResponseEntity<ApplicationResponseDTO> apply(@PathVariable Long jobId, HttpServletRequest req) {
        return ResponseEntity.status(HttpStatus.CREATED).body(jobService.apply(jobId, extractUserId(req)));
    }
